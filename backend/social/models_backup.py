...
# Simple organization model for social-media standalone app
...
class SocialComment(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='social_comments')
...
class SocialIdea(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='social_ideas')
...
class SocialHashtag(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='social_hashtags')
...
class SocialQueue(models.Model):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='social_queues')
    account = models.ForeignKey(SocialAccount, on_delete=models.CASCADE)
...
class SocialMediaFile(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='social_media_files')
